...
from selfutil import ImageInput, ProcessorMixin, TensorType
...
class Processor(ProcessorMixin):
    ...
    [`Processor`] offers all the functionalities of [`FlavaImageProcessor`] and [`BertTokenizerFast`]. See the
    [`~Processor.__call__`] and [`~Processor.decode`] for more information.
